...
_WindowsList.add(new _Window("en tete", 100, 100, 300, 400));
_WindowsList.add(new _Window("en tete", 13, 100, 300, 400));
_WindowsList.add(new _Window("hehe", 600, 100, 100, 600));
_WindowsList.add(new _Window("hehe", 600, 100, 100, 600));
